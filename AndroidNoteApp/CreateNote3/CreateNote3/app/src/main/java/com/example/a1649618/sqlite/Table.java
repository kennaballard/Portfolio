...
public abstract class Table<T extends Identifiable<Long>> implements CRUDRepository<Long, T> {
     ...
     */
    public abstract T fromCursor(Cursor cursor) throws DatabaseException, ParseException;
    ...
    @Override
    public T read(Long id) throws DatabaseException, ParseException {
    ...
    @Override
    public List<T> readAll() throws DatabaseException, ParseException {
        SQLiteDatabase database = dbh.getReadableDatabase();
